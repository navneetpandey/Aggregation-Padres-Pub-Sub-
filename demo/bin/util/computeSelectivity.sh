...
USAGE="Usage: $(basename $0) [-Xms <mem_min>] [-Xmx <mem_max>] [-subs <subfile>] [-pubs <subfile>] [-key <key field>]..."
...
java -Xms${MEMORY_MIN}m -Xmx${MEMORY_MAX}m \
    ...
    ca.utoronto.msrg.padres.demo.selectivityComputer.ComputeSelectivity ${CLIENT_OPT[@]}
