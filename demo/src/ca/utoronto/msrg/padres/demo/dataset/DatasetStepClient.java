...
public abstract class DatasetStepClient extends Client {
	// Keeps track of the brokers that we visited
		 ...
		 */
		protected DatasetStepClient(ClientConfig clientConfig) throws ClientException {
			super(clientConfig);
		...
		protected abstract String getDataFilePath(String symbol);
}
