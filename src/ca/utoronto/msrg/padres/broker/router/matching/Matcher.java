...
public interface Matcher {
	...
	/**
	 * fetch the advertisement messages match this
	 * subscription message. 
	 * 
	 * @param subscription message m
	 * @return set of advertisements
	 * @throws MatcherException
	 */
	public Set<String> getMatchingAdvFromSubs(SubscriptionMessage m) throws MatcherException;
