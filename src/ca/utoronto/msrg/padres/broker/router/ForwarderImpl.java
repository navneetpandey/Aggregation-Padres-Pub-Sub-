...
public class ForwarderImpl implements Forwarder {
	 ...
	 * @return
	 */
	protected Set<PublicationMessage> forwardPubMsg(PublicationMessage pubMsg, Set<String> subIDs) {
	...
	protected List<Object> chooseBestPathForPublication(String msgID, MessageDestination lastHop) {
