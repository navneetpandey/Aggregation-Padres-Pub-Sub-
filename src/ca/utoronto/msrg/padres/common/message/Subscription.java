...
public class Subscription implements Serializable {
	...
	private long aggSubID;
	
	private AggregationID aggregationID;

	public OperatorType getAggOperator() {
		return aggregationID.getOperatorType();
	}

	
	public long getAggSubID() {
		return aggSubID;
	}
	...
	public Subscription duplicate() {
		...
		newSub.aggregation =this.aggregation;
		newSub.aggregationID=this.aggregationID;
		return newSub;
	}
