...
public class AggregationClientTestEarly extends TestCase {
...
/*brokerCore3.getBrokerConfig().getAggregationInfo().setClientAggregation(true);
	...
	public void testMessageRecievedOneBrokerMultiplePublicationSingleSubscription()
			throws ClientException, ParseException, BrokerCoreException,
			InterruptedException, UnknownHostException {
	...
	public void testMessageRecievedTwoBrokerMultiplePublicationTwoSubscription()
			throws ClientException, ParseException, BrokerCoreException,
			InterruptedException, UnknownHostException {
		...
		clientSub1.subscribe(
				"[class,eq,STOCK],[value,>,60],[AGR,eq,'range'],[PAR,eq,value],[PRD,eq,'5'],[NTF,eq,'1']", "rmi://localhost:1101/Broker1");
		clientSub2.subscribe(
				"[class,eq,STOCK],[value,>,65]", "rmi://localhost:1101/Broker1");
		Thread.sleep(5100L);
...
//
//		assertEquals(0,clientSub1.getNonAggregateMessageReceived());
		assertEquals(0,clientSub2.getAggregateMessageReceived());
		assertEquals(7,clientSub2.getNonAggregateMessageReceived());
	}
	
	public void testMessageRecievedOneBrokerMultiplePublicationTwoSubscription()
			throws ClientException, ParseException, BrokerCoreException,
			InterruptedException, UnknownHostException {
