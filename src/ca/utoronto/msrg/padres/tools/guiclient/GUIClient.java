...
import ca.utoronto.msrg.padres.client.AggregationPrinter;
...
public class GUIClient extends Client implements ActionListener {
	...
	private final boolean  FOR_CLIENT_AGGREGATION = false;
	
	public GUIClient(String id) throws ClientException {
		super(id);
		if(FOR_CLIENT_AGGREGATION)
			getAndPrintAggregationMessage();
	}
	...
	public void getAndPrintAggregationMessage(){
		Publication printMsg = new Publication();
		AggregationPrinter aggregationPrinter = new AggregationPrinter(this, printMsg);
		super.notificationThread(printMsg,aggregationPrinter);
			 
		Thread t = new Thread (aggregationPrinter, "aggregationPrinter");
		t.start();
	...
	public void printNotification(String outString, Color txtColor) {
		try {
